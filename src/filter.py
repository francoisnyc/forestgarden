...
_AGENCY_KEYWORDS = {
    "HPD": ["HOUSING PRESERVATION", "HOUSING PRES"],
    "DCAS": ["CITYWIDE ADMIN", "DEPT OF CITYWIDE"],
    "MTA": ["METROPOLITAN TRANSPORTATION", "MTA -", "MTA-"],
    "DOT": ["DEPT OF TRANSPORTATION", "DEPARTMENT OF TRANSPORTATION"],
    "DEP": ["ENVIRONMENTAL PROTECTION"],
    "NYCHA": ["HOUSING AUTHORITY"],
    "SCA": ["SCHOOL CONSTRUCTION"],
    "DOE": ["DEPT OF EDUCATION", "DEPARTMENT OF EDUCATION"],
    "PARKS": ["DEPT OF PARKS", "PARKS AND RECREATION", "NYS PARKS RECREATION"],
}
